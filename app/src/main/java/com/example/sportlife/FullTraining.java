...
public class FullTraining extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        startButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                sendTrainingDataToHomeActivity("Полная тренировка", R.drawable.training_one);
                startTimer();
            }
        });
    ...
    private void startTimer() {
        ...
        updateTimer(40 * 60 * 1000); // 40 минут в миллисекундах

        // Создаем и запускаем таймер обратного отсчета на 40 минут
        countDownTimer = new CountDownTimer(40 * 60 * 1000, 1000) {
            @Override
