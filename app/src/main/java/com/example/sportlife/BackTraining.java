...
public class BackTraining extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_back_training);
        ...
        startButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                sendTrainingDataToHomeActivity("Тренировка спины", R.drawable.training_four);
                startTimer();
            }
        });
    ...
    private void startTimer() {
        ...
        updateTimer(50 * 60 * 1000); // 50 минут в миллисекундах

        // Создаем и запускаем таймер обратного отсчета на 50 минут
        countDownTimer = new CountDownTimer(50 * 60 * 1000, 1000) {
            @Override
