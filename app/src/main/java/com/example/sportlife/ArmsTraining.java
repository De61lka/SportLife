...
public class ArmsTraining extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        startButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                sendTrainingDataToHomeActivity("Тренировка рук", R.drawable.training_two);
                startTimer();
            }
        });
    ...
    private void startTimer() {
        ...
        updateTimer(30 * 60 * 1000); // 30 минут в миллисекундах

        // Создаем и запускаем таймер обратного отсчета на 30 минут
